...
public class WordFinder {
   ...
   private static void run(Scanner in){
      ...
      TreeMap<Integer,ArrayList<String>> scores = scoresAndWords(allWords);
   ...
   private static TreeMap<Integer,ArrayList<String>> scoresAndWords(ArrayList<String> allWords) {
